...
<%
   User us = new User();
	...
	int id=Integer.parseInt(request.getParameter("us_id"));
	us=ud.getUserByUserId(id);
%>
...
<main>
<div class="chaman">
  <div class="container " style="margin: 0px 26vw;">
    <div class="card" style="width: 53rem; height:80vh; border-radius:18px;">
  <img class="card-img-top" src="pics/<%=us.getProfile()%>" alt="Card image cap" style="    border-radius: 17%;    padding: 25px 0px;     max-width: 147px;   margin: 0px 33px;">
  <div class="card-body">
    <h5 class="card-title"><%=us.getName() %></h5>
    <p class="card-text"><%=us.getAbout() %></p>
